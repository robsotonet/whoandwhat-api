...
public interface IScheduledItemRepository : IRepository<ScheduledItem>
{
    ...
    public Task<IEnumerable<ScheduledItem>> GetByUserAndDateRangeAsync(Guid userId, DateTime startDate, DateTime endDate, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<ScheduledItem>> GetByUserAndDateAsync(Guid userId, DateTime date, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<ScheduledItem>> GetActiveItemsAsync(Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<ScheduledItem>> GetUpcomingItemsAsync(Guid userId, int hoursAhead = 24, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<ScheduledItem>> GetOverdueItemsAsync(Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<ScheduledItem>> GetByItemTypeAsync(Guid userId, int itemType, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<ScheduledItem>> GetByCategoryAsync(Guid userId, string category, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<ScheduledItem>> GetByTaskIdAsync(Guid taskId, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<ScheduledItem>> GetExternalCalendarItemsAsync(Guid userId, string? calendarSource = null, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<ScheduledItem>> GetConflictingItemsAsync(Guid userId, DateTime startTime, DateTime endTime, Guid? excludeItemId = null, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<ScheduledItem>> GetFlexibleItemsAsync(Guid userId, DateTime startDate, DateTime endDate, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<ScheduledItem>> GetByTimeBlockAsync(Guid timeBlockId, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<ScheduledItem>> GetLowConfidenceItemsAsync(Guid userId, double maxConfidenceScore = 0.5, CancellationToken cancellationToken = default);
    ...
    public Task<int> BulkUpdateCompletionStatusAsync(IEnumerable<Guid> itemIds, bool isCompleted, Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<int> BulkRescheduleAsync(Dictionary<Guid, (DateTime StartTime, DateTime EndTime)> reschedulingData, Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<int> DeleteOldItemsAsync(Guid userId, DateTime olderThan, CancellationToken cancellationToken = default);
    ...
    public Task<Dictionary<string, object>> GetSchedulingStatisticsAsync(Guid userId, DateTime startDate, DateTime endDate, CancellationToken cancellationToken = default);
    ...
    public Task<Dictionary<string, double>> GetProductivityCorrelationsAsync(Guid userId, string? category = null, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<(TimeSpan StartTime, TimeSpan EndTime, double SuccessRate)>> GetOptimalTimeSlotsAsync(Guid userId, string category, TimeSpan duration, CancellationToken cancellationToken = default);
    ...
    public Task<bool> ItemBelongsToUserAsync(Guid itemId, Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<Dictionary<string, object>> GetSchedulingTrendsAsync(Guid userId, int days = 30, CancellationToken cancellationToken = default);
}
