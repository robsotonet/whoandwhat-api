...
public interface ISchedulingPatternRepository : IRepository<SchedulingPattern>
{
    ...
    public Task<IEnumerable<SchedulingPattern>> GetActivePatternsByUserAsync(Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<SchedulingPattern>> GetReliablePatternsByUserAsync(Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<SchedulingPattern>> GetPatternsByTypeAsync(Guid userId, string patternType, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<SchedulingPattern>> GetApplicablePatternsAsync(Guid userId, DateTime time, string? category = null, List<string>? tags = null, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<SchedulingPattern>> GetHighProductivityPatternsAsync(Guid userId, double minCorrelation = 0.7, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<SchedulingPattern>> GetPatternsNeedingMoreDataAsync(Guid userId, int minReinforcementCount = 5, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<SchedulingPattern>> GetPatternsByCategoriesAsync(Guid userId, List<string> categories, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<SchedulingPattern>> GetPatternsByDaysOfWeekAsync(Guid userId, List<DayOfWeek> daysOfWeek, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<SchedulingPattern>> GetPatternsByTimeRangeAsync(Guid userId, TimeSpan startTime, TimeSpan endTime, int tolerance = 30, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<SchedulingPattern>> GetSimilarPatternsAsync(SchedulingPattern referencePattern, double similarityThreshold = 0.7, int maxResults = 10, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<SchedulingPattern>> GetOptimizationEligiblePatternsAsync(Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<SchedulingPattern>> GetRecentlyViolatedPatternsAsync(Guid userId, TimeSpan recentPeriod, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<SchedulingPattern>> GetHighSuccessRatePatternsAsync(Guid userId, double minSuccessRate = 0.8, string? category = null, CancellationToken cancellationToken = default);
    ...
    public Task<int> BulkReinforceAsync(Dictionary<Guid, double> reinforcements, Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<int> BulkRecordViolationsAsync(IEnumerable<Guid> patternIds, Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<int> DeactivatePoorPerformingPatternsAsync(Guid userId, double maxSuccessRate = 0.3, int minReinforcementCount = 10, CancellationToken cancellationToken = default);
    ...
    public Task<Dictionary<string, object>> GetPatternStatisticsAsync(Guid userId, string? patternType = null, CancellationToken cancellationToken = default);
    ...
    public Task<Dictionary<string, object>> GetProductivityInsightsAsync(Guid userId, TimeSpan? analysisPeriod = null, CancellationToken cancellationToken = default);
    ...
    public Task<Dictionary<string, object>> GetPatternEvolutionAsync(Guid userId, Guid patternId, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<SchedulingPattern>> CreateOrUpdatePatternsFromBehaviorAsync(Guid userId, Dictionary<string, object> behaviorData, CancellationToken cancellationToken = default);
    ...
    public Task<List<string>> GetPatternImprovementRecommendationsAsync(Guid userId, Guid patternId, CancellationToken cancellationToken = default);
    ...
    public Task<bool> PatternBelongsToUserAsync(Guid patternId, Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<int> DeleteInactivePatternsAsync(Guid userId, TimeSpan inactiveThreshold, CancellationToken cancellationToken = default);
    ...
    public Task<Dictionary<string, object>> GetMachineLearningFeaturesAsync(Guid userId, CancellationToken cancellationToken = default);
}
