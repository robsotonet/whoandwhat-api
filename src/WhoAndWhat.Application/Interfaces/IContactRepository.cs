...
public interface IContactRepository : IRepository<Contact>
{
    ...
    public Task<Contact?> GetContactIncludingDeletedAsync(Guid contactId, Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<Contact>> GetDeletedContactsAsync(Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<Contact?> GetContactWithTasksAsync(Guid contactId, Guid userId, bool includeDeletedTasks = false, CancellationToken cancellationToken = default);
    ...
    public Task<bool> SoftDeleteContactAsync(Guid contactId, Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<bool> RestoreContactAsync(Guid contactId, Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<bool> PermanentlyDeleteContactAsync(Guid contactId, Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<Contact>> GetContactsSafeToDeleteAsync(Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<int> CountActiveTaskAssociationsAsync(Guid contactId, Guid userId, CancellationToken cancellationToken = default);
