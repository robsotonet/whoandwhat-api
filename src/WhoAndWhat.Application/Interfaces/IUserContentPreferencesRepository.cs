...
public interface IUserContentPreferencesRepository : IRepository<UserContentPreferences>
{
    ...
    public Task<UserContentPreferences?> GetByUserIdAsync(Guid userId, CancellationToken cancellationToken = default);
    ...
    public Task<int> ResetDailyDeliveryCountsAsync(CancellationToken cancellationToken = default);
    ...
    public Task<IEnumerable<UserContentPreferences>> GetUsersEligibleForContentAsync(
        int currentHour,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>True if update was successful</returns>
    public Task<bool> UpdateEngagementMetricsAsync(
        Guid userId,
    ...
    public Task<IEnumerable<UserContentPreferences>> GetHighEngagementUsersAsync(
        double minScore = 0.7,
        int count = 100,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>True if update was successful</returns>
    public Task<bool> UpdateOptimalDeliveryHoursAsync(
        Guid userId,
